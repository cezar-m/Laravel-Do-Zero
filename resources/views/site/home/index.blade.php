...
<section class="category gray-background">
	<div class="main-wrapper flex-container">
		<section class="cultivation__category">
			<picture>
				<source media="(max-width: 768px)" srcset="{{asset('images/images/rachel-moenning-zjxYwd4HOu0-unsplash.jpg')}}">
	...
	<div class="main-wrapper">
		<div class="blog__container">
			...
			<article class="card__post">
				<a href="javascript:;">
					<div class="post__cover">
						<img src="{{asset('images/blog/safar-safarov-MSN8TFhJ0is-unsplash.jpg')}}">
					</div>
			...
			<article class="card__post">
				<a href="javascript:;">
					<div class="post__cover">
						<img src="{{asset('images/blog/roman-synkevych-vXInUOv1n84-unsplash.jpg')}}">
					</div>
					<header class="card__post__header">
						<time class="post__date" datetime="2019-03-29">18 Julho, 2019</time>
			...
			<article class="card__post">
				<a href="javascript:;">
					<div class="post__cover">
						<img src="{{asset('images/blog/max-duzij-qAjJk-un3BI-unsplash.jpg')}}">
					</div>
					<header class="card__post__header">
						<time class="post__date" datetime="2019-03-29">18 Julho, 2019</time>
